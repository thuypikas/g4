...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div id="tibber">
        ...
        <h2 style="width:960px;color: green; ">&nbsp;&nbsp;Apple</h2>
            <br />
          <asp:FormView ID="FormView1" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1" AllowPaging="True">
              ...
              <ItemTemplate>
                ...
                <h2 style="width:960px;color: green;">&nbsp;&nbsp;Xiaomi</h2>
           <div>
               <asp:FormView ID="FormView2" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1" AllowPaging="True">
              <EditItemTemplate>
                  Id:
                  <asp:Label ID="IdLabel1" runat="server" Text='<%# Eval("Id") %>' />
                  <br />
            ...
            <h2 style="width:960px;color: green;">&nbsp;&nbsp;Oppo</h2>
            <div>
                 <asp:FormView ID="FormView3" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1" AllowPaging="True">
              <EditItemTemplate>
                  Id:
                  <asp:Label ID="IdLabel1" runat="server" Text='<%# Eval("Id") %>' />
                  <br />
